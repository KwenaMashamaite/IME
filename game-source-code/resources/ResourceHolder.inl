...
namespace IME {
    ...
    template<>
    //Function template specialization (sf::Music is streamed from disk rather than loaded into memory)
    inline void
    ResourceHolder<sf::Music>::loadFromFile(const std::string &filename) {
