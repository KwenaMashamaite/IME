        ...
        switch (event.type){
            ...
            case sf::Event::KeyPressed:
                Events::keyPressed.notifyListeners(
                    static_cast<InputManager::Key>(static_cast<unsigned int>(event.key.code))
                ); break;
            ...
            case sf::Event::MouseMoved:
                Events::mouseMoved.notifyListeners(event.mouseMove.x, event.mouseMove.y);
                break;
            case sf::Event::MouseButtonPressed:
                Events::mouseButtonPressed.notifyListeners(
                    static_cast<InputManager::MouseButton>(static_cast<unsigned int>(event.mouseButton.button)),
                    renderTarget.getMousePosition().x, renderTarget.getMousePosition().y
                ); break;
