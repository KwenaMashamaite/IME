...
namespace IME::Gui {
    ...
    void MainMenu::createNavigationButtons() {
    ...
    void MainMenu::initNavigationButtonActions() {
    ...
    void MainMenu::draw(Window &renderTarget) {
        switch (state_){
    ...
    void MainMenu::updateInfoPanel(const std::string& newInfo) {
    ...
    void MainMenu::createReturnButton() {
