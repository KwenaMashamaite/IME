...
void Gui::Drawer::drawEntity(const EntityAnimatorPair &entityAnimatorPair) {
...
void Gui::Drawer::drawEntities(const std::initializer_list<EntityAnimatorPair> &entityAnimatorPairs) {
