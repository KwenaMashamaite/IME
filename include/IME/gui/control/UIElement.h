    ...
    namespace Gui {
        ...
        public:
            ...
            */
             ...
             * @return Current size of the element
             *
             * The size includes the set margin, padding and outline thickness
             */
            ...
            /**
             * @brief Get the elements text content
             * @return Elements text content
             */
            std::string getText() const;

            /**
             * @brief Get the outline thickness of the element
             * @return Outline thickness of the element
             */
             ...
             */
            unsigned int getTextCharSize() const;
