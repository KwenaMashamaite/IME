...
namespace IME {
    namespace Utility {
        ...
        public:
             ...
             */
            bool addProperty(const std::string& name, const std::string& type, const std::string& key);

            /**
             * @brief Set the value of a property
             * @param name Name of the property
             * @param value New val;ue of the prioperty
             */
        ...
        private:
             ...
             * @param name Nam of the property
             * @return True if property exists otherwise false
             */
            std::pair<bool, int> hasProperty_(const std::string& name) const;

            std::string getAttributeFor(const std::string& name, const std::string& what) const;

            void setInProperty(const std::string& name, const std::string& type, const std::string& value);
